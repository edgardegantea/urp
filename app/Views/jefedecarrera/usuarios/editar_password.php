...
<?= $this->section('content'); ?>
    ...
    <div class="row g-3 mt-5">
        ...
        <div class="col text-center">
            <form method="post" action="<?php echo base_url('jefedecarrera/usuarios/update_password/' . $usuario['id']); ?>">
                ...
                <a href="<?= base_url('jefedecarrera/usuarios') ?>" class="mt-3 btn btn-default float-right">Cancelar y regresar</a>
            </form>
        </div>
        <div class="col"></div>
